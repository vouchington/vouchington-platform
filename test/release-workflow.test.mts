...
describe('release workflow', () => {
  ...
  it('projects a reviewed legacy compiler patch to its fixed release line', () => {
    const patch = readFileSync('releases/localization-compiler/0.0.5.patch')
    ...
    expect(workflow).toContain('LEGACY_BASE_TAG: localization-compiler-v0.0.4')
    expect(workflow).toContain('LEGACY_BASE_SHA: 724a5402580919bab2935b81e95f08b890fffb1c')
    ...
    expect(workflow).toContain('RELEASE_BRANCH=release/localization-compiler-0.0.5')
  })
